...
function Chat() {
  return (
    <div className='container mx-auto bg-gray-200 mt-5 w-1/2'>
      <div className='p-5'>
        <p className='bg-gray-300 rounded-lg p-5 m-5'>Do you want to get notified when a new component is added to Flowbite? Sign up for our newsletter and you'll be among the first to find out about new features, components, versions, and tools.</p> 
