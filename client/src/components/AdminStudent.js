...
function AdminStudent() {
  return (
    ...
    <AdminNav/>
    <div className=" container flex ml-40 mr-20 content-center justify-center  dark:text-gray-700   mt-30">
        <div className=' '>
      ...
      <tbody className=' break-word text-center'>
        <tr className="bg-blue-100 border-b text-black rounded-lg  dark:border-gray-700">
          ...
          <td className='pt-4 pb-4 p-4 text-md '>amangangwar55@gmail.com</td>
          <td className='pt-4 pb-4 p-4 text-md '>95723261XXX</td>
      ...
      <tbody className=' break-word text-center'>
        <tr className="bg-blue-100 border-b text-black rounded-lg  dark:border-gray-700">
          ...
          <td className='pt-4 pb-4 p-4 text-md '>yasif9155@gmail.com</td>
          <td className='pt-4 pb-4 p-4 text-md '>957232XXXX</td>
